...
Het (eng. {\em Hat -- Haskell tracer}) je alat koji se koristi za generisanje {\em traga} (eng. {\em trace}) prilikom izvršavanja Haskel programa
...
se ogleda upravo u upotrebi {\em traga}, jer se programeru pruža pogled unutar ``crne kutije'', tj. sva izračunavanja u našem Haskel programu bivaju razmotana u niz redukcija koja programer može da analizira.
...
potrebno ga je prvo transformisati korišćenjem alata koji se sadrži u Hetu pod nazivom {\em hat-trans}. U tom procesu se svaki modul iz našeg Haskel programa transformišu 
...
{\em hat-observe} & { Prikazuje kako se koriste funkcije najvišeg nivoa, } \\ & 
		    ...
		    { sa kojima je data funkcija pozivana prilikom izračunavanja }\\ & 
		    { programa zajedno sa rezultatima tih poziva. \cite{hat_haskell_org}}\\ \hline
...
{\em hat-stack} & { Ovaj alat za neuspešna izvršavanja programa nagoveštava } \\ & 
		  { u kojoj funkciji je došlo do prekida izvršavanjam, } \\ & 
...
{\em hat-explore} & { Slično kao i kod uobičajenih debagera, ovaj alat }\\ &
		    ...
		    { se nalazi prilikom izračunavanja programa \cite{hat_haskell_org}.}\\ \hline
\end{tabular}

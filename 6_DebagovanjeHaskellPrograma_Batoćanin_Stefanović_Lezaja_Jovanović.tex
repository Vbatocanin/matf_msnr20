...
{
\emph{Softverski bag} je se može definisati kao bilo koje nepredviđeno ponašanje programa. Popravljanje programa u kome su prisutni bagovi se sastoji iz sistematičnog proveravanja odlika odnosno željenog ponašanja programa, odnosno da li dobijemo očekivani izlaz za dati ulaz. Poenta ovog procesa jeste da nađemo scenario u kome program ne daje poželjnu povratnu informaciju. Ovom postupku najčešće sledi lociranje uzroka problema, iako je moguće da samim ispitivanjem postojanja baga implicitno dobijemo dovoljno informacija o njegovoj lokaciji. Ovaj proces se naziva \textbf{debagovanje}.\cite{stallman2002debugging}\\
